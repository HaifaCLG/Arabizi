...
frequent_en_words = ['the', 'be', 'and', 'a', 'of', 'to', 'in', 'i', 'you', 'it', 'have', 'to', 'that', 'for', 'do',
...
frequent_fr_words = ['bonjour', 'au', 'revoir', 'oui', 'non', 'merci', 'beaucoup', 'fille', 'garçon', 'femme', 'homme',
                     'amour', 'français', "s’il" ,'vous','plaît','bonsoir','bonne', 'nuit',' excusez-moi','de rien','je','en','prie',
                    'temps','jour','monde','monsieur','raison','mademoiselle','madame','beau','belle','chat','chien','fort']

frequent_fr_words.extend(['lettre', 'entendu', 'recueillir', 'cher', 'figure', 'pli', 'augmenter', 'deux', 'acheté', 'aile', 'hommes', 'obtenir', 'pause', 'souvent', 'vitesse', 'gamme', 'seul', 'été', 'verbe', 'fleur', 'chat', 'chaleur', 'ces', 'sûr', 'assez', 'mine', 'manquer', 'aimant', 'pensée', 'plus', 'herbe', 'étrange', 'doigt', 'changement', 'clair', 'voyage', 'dont', 'usine', 'certain', 'rail', 'fille', 'décrire', 'nombre', 'oh', 'vieux', 'première', 'part', 'fabriqué', 'canard', 'moins', 'cou', 'chance', 'rester', 'colère', 'ici', 'pauvres', 'syllabe', 'entendre', 'table', 'frais', 'commencer', 'lire', 'qui', 'minute', 'village', 'compter', 'capture', 'processus', 'poisson', 'tirer', 'cheveux', 'surprise', 'grand', 'remplir', 'sauter', 'enattente', 'leur', 'regarder', 'rappeler', 'face', 'poser', 'voir', 'coût', 'oxygène', 'moi', 'milieu', 'nom', 'groupe', 'sélectionner', 'ligne', 'droit', 'ran', 'caractère', 'différer', 'effet', 'frapper', 'matériel', 'parler', 'banque', 'sedemander', 'plan', 'magasin', 'riche', 'puis', 'loin', 'vivre', 'lait', 'cas', 'symbole', 'compétence', 'insecte', 'dictionnaire', 'costume', 'pourrait', 'court', 'litre', 'mais', 'anneau', 'peut-être', 'poste', 'suivant', 'couleur', 'personnes', 'long', 'longueur', 'machine', 'glace', 'heureux', 'atome', 'courir', 'conservé', 'boisson', 'sang', 'autre', 'visite', 'majeur', 'prouver', 'masse', 'mois', 'pays', 'principal', 'chauve-souris', 'son', 'probable', 'bas', 'système', 'test', 'sauver', 'soirée', 'dire', 'mensonge', 'mille', 'condition', 'feutre', 'bord', 'roi', 'comme', 'organiser', 'rayon', 'plat', 'plusieurs', 'unefois', 'record', 'gouverner', 'après', 'avec', 'couvercle', 'lent', 'figue', 'comment', 'joindre', 'mot', 'sourire', 'vouloir', 'voler', 'triangle', 'capitaine', 'nécessaire', 'fait', 'décider', 'école', 'signifier', 'paraître', 'vache', 'noir', 'aucun', 'femmes', 'être', 'énergie', 'aaugmenté', 'opposé', 'sec', 'huit', 'branche', 'vapeur', 'chanter', 'trop', 'sœur', 'instant', 'certains', 'blanc', 'cri', 'pieds', 'saison', 'zone', 'monture', 'débit', 'difficile', 'je', 'peindre', 'avis', 'a', 'égal', 'soldat', 'ou', 'lacause', 'reste', 'vague', 'océan', 'complète', 'sont', 'vie', 'espoir', 'pouce', 'attendre', 'lumière', 'aider', 'résoudre', 'ville', 'esclave', 'notre', 'de', 'unique', 'plutôt', 'désert', 'charger', 'danger', 'phrase', 'interroger', 'volonté', 'maître', 'supporter', 'observer', 'os', 'dans', 'à', 'récolte', 'deuxième', 'lot', 'alimentation', 'appel', 'LED', 'relier', 'rapide', 'passé', 'heure', 'est', 'lieu', 'la', 'radio', 'acier', 'centre', 'croire', 'terre', 'pourquoi', 'feu', 'servir', 'maintenant', 'père', 'nous', 'consonne', 'carte', 'tête', 'prendre', 'lune', 'jardin', 'chiffre', 'bloc', 'feuille', 'homme', 'sentir', 'vue', 'prèsde', 'habituel', 'semence', 'lourd', 'fort', 'mère', 'vers', 'varier', 'fournir', 'sept', 'où', 'cinq', 'porte', 'haut', 'dernier', 'assimiler', 'rouge', 'mélanger', 'nuage', 'exact', 'elle', 'enfant', 'mesurer', 'rire', 'voyelle', 'pousser', 'espace', 'dame', 'plein', 'signe', 'juste', 'chemin', 'lui', 'chambre', 'profond', 'chapeau', 'balle', 'foule', 'cercle', 'idée', 'rivage', 'prêt', 'beaucoup', 'échelle', 'boutique', 'station', 'tous', 'sud', 'dit', 'épais', 'presse', 'passer', 'colonie', 'enfants', 'vêtir', 'électrique', 'méthode', 'tel', 'marché', 'marcher', 'organe', 'pied', 'événement', 'mauvais', 'oreille', 'ascenseur', 'discours', 'neserapas', 'large', 'avoir', 'sucre', 'dollar', 'apporter', 'voiture', 'réel', 'ordre', 'poids', 'bientôt', 'deviner', 'conduire', 'étudiant', 'exemple', 'esprit', 'lac', 'debase', 'dix', 'il', 'tout', 'silencieux', 'commerce', 'nourriture', 'moment', 'entreprise', 'étape', 'bouche', 'million', 'lien', 'chef', 'ennemi', 'depuis', 'moteur', 'fruit', 'science', 'coin', 'chaise', 'graphique', 'mer', 'vérifier', 'troisième', 'corps', 'racine', 'fraction', 'simple', 'conception', 'paragraphe', 'marque', 'rue', 'température', 'déterminer', 'trou', 'rose', 'sauvage', 'segment', 'vous', 'très', 'acte', 'ceux', 'forme', 'rock', 'division', 'produit', 'essayer', 'voile', 'voix', 'ilya', 'suivre', 'payer', 'bureau', 'arbre', 'période', 'piste', 'garçon', 'chose', 'pose', 'amusement', 'pain', 'aller', 'revendication', 'bateau', 'viande', 'àpartirde', 'modèle', 'boîte', 'envisager', 'gris', 'vallée', 'finition', 'point', 'or', 'entraînement', 'répondre', 'monde', 'finale', 'coupe', 'soi', 'étoile', 'pendant', 'protéger', 'sens', 'côte', 'tube', 'similaire', 'soustraire', 'acheter', 'apprendre', 'au-dessus', 'enseigner', 'utiliser', 's’ilvousplaît', 'soudain', 'tandisque', 'semettred’accord', 'lit', 'recherche', 'montagne', 'Arrêtez', 'bienque', 'coup', 'dépendre', 'roue', 'odeur', 'liste', 'poussin', 'estvenu', 'œil', 'midi', 'produire', 'ouvert', 'ferme', 'acommencé', 'voisin', 'commun', 'faire', 'moderne', 'régler', 'touslesdeux', 'représenter', 'navire', 'savoir', 'musique', 'savait', 'langue', 'élément', 'chaîne', 'ainsi', 'pour', 'inventer', 'histoire', 'fenêtre', 'quotient', 'discuter', 'genre', 'spécial', 'règle', 'donné', 'succès', 'substance', 'recevoir', 'jaune', 'porter', 'préparer', 'minuscule', 'pluie', 'serencontrent', 'partie', 'lointain', 'cent', 'montrer', 'pas', 'travail', 'particulièrement', 'gagner', 'entrer', 'sujet', 'niveau', 'île', 'chien', 'équipe', 'ils', 'célèbre', 'pomme', 'pierre', 'humain', 'cassé', 'eu', 'nature', 'tronçon', 'pluriel', 'fonctionner', 'ce', 'que', 'nuit', 'amour', 'pistolet', 'moitié', 'famille', 'sol', 'ajouter', 'taille', 'corde', 'h', 'vrai', 'total', 'question', 'copie', 'surface', 'décès', 'sable', 'bande', 'baignade', 'manger', 's’asseoir', 'étude', 'expédié', 'jamais', 'nord', 'bruit', 'décimal', 'battre', 'propre', 'main', 'outil', 'original', 'objet', 'courant', 'jambe', 'dur', 'présent', 'problème', 'emploi', 'support', 'bleu', 'tard', 'dents', 'nez', 'neige', 'œuf', 'seulement', 'vert', 'fracture', 'sous', 'ami', 'cloche', 'garder', 'paire', 'solution', 'contenir', 'faible', 'gaz', 'propriété', 'beauté', 'puissance', 'cour', 'résultat', 'mur', 'atteindre', 'fils', 'étage', 'papa', 'train', 'bâton', 'intérêt', 'art', 'vingt', 'brun', 'port', 'pratique', 'seproduire', 'écouter', 'horloge', 'étaient', 'signifiait', 'jouer', 'suggérer', 'exiger', 'jeune', 'bon', 'souhaiter', 'fer', 'molécule', 'chaud', 'oui', 'danse', 'sedépêcher', 'enregistrer', 'déménagement', 'apparaître', 'arriver', 'tomber', 'toucher', 'queue', 'comparer', 'argent', 'jour', 'rivière', 'bras', 'pneu', 'mort', 'région', 'aussi', 'médecin', 'bien', 'femme', 'guider', 'multiplier', 'toujours', 'manteau', 'papier', 'route', 'réponse', 'sur', 'place', 'frère', 'peut', 'si', 'encore', 'colline', 'naturel', 'siège', 'épaule', 'mile', 'meilleur', 'verre', 'rencontre', 'épeler', 'ensemble', 'les', 'robe', 'sombre', 'bois', 'ne', 'âge', 'carré', 'coquille', 'guerre', 'soleil', 'terme', 'Terminé', 'indiquer', 'needsacontext', 'traverser', 'peur', 'continuer', 'mettre', 'scie', 'Voyage', 'vendre', 'liquide', 'état', 'mouvement', 'estallé', 'eau', 'sauf', 'développer', 'difficulté', 'jusqu’à', 'grandiose', 'chanson', 'colonne', 'devrait', 'rub', 'brûler', 'par', 'semaine', 'score', 'disparu', 'six', 'Note', 'apporté', 'montée', 'peupler', 'temps', 'facilité', 'venir', 'net', 'page', 'accord', 'localiser', 'sel', 'écrire', 'fin', 'peau', 'résisté', 'exciter', 'degré', 'ni', 'expérience', 'doux', 'entre', 'propagation', 'choisir', 'camion', 'unité', 'rouleau', 'petit', 'type', 'proposition', 'contre', 'votre', 'coffre-fort', 'mal', 'quand', 'construire', 'classe', 'tuer', 'suffixe', 'domaine', 'clé', 'mourir', 'cellule', 'début', 'tôt', 'général', 'rien', 'imaginer', 'contrôle', 'graisse', 'maison', 'verslebas', 'nation', 'air', 'derrière', 'conseil', 'trouver', 'valeur', 'proche', 'jeu', 'mieux', 'bébé', 'inclure', 'huile', 'dehors', 'vent', 'même', 'sommeil', 'siècle', 'répétition', 'chaussure', 'né', 'écrit', 'personne', 'capital', 'envoyer', 'double', 'printemps', 'apris', 'planète', 'ouest', 'continent', 'sat', 'croître', 'oiseau', 'exercice', 'tenir', 'donner', 'forêt', 'avant', 'trois', 'peu', 'voudrais', 'ton', 'favoriser', 'là', 'pièce', 'gratuit', 'soins', 'capable', 'gauche', 'cours', 'force', 'cœur', 'image', 'occupé', 'correct', 'éclat', 'quatre', 'raison', 'ciel', 'rangée', 's’adapter', 'industrie', 'possible', 'poème', 'cuisinier', 'pris', 'doit', 'besoin', 'position', 'cheval', 'blé', 'chasse', 'impression', 'séparé', 'matin', 'énorme', 'fil', 'froid', 'livre', 'mince', 'bar', 'glissement', 'joie', 'et', 'mélodie', 'année', 'direct', 'patienter', 'lutte', 'manière', 'animal', 'calme', 'trouvé', 'créer', 'section', 'esttombé', 'plaine', 'base', 'était', 'jeter', 'camp', 'un', 'hiver', 'permettre', 'toutàfait', 'perdu', 'métal', 'chaque', 'penser', 'laisser', 'lavage', 'ma', 'nouveau', 'côté', 'course', 'neuf', 'merci', 'ilfaut', 'tour', 'arrière', 'jusqu’àceque', 'rêver', 'instrument', 'coton', 'particulier'])
...
def select_random_sentences(dir_name,out_file,sample_num):
    for file_name in os.listdir(dir_name):
        with open(dir_name+'\\'+file_name, 'r', encoding="utf-8") as f,open(out_file,'a',encoding="utf-8",newline='') as out:
            ...
            random_choice = random.sample(lines, sample_num)
            out.writelines(random_choice)

#checking duplications of reddit/twitter file passed as a parameter
def check_duplications(csv_file):
    with open(csv_file, 'r', encoding="utf-8") as f1:
        reader = csv.reader(f1)
        posts=[row[1]+','+row[3] for row in reader]
        posts_unique=list(set(posts))
        print(len(posts)-len(posts_unique))
        import collections
        print([item for item, count in collections.Counter(posts).items() if count > 1])
